...
object AndroidPDFService {
    ...
    suspend fun downloadPDF(
        ...
        try {
            ...
            Log.d("AndroidPDFService", "PDF guardado en: ${htmlFile.absolutePath}")
            ...
            Log.e("AndroidPDFService", "Error guardando PDF: ${e.message}")
            onError("Error guardando PDF: ${e.message}")
        } catch (e: Exception) {
            Log.e("AndroidPDFService", "Error inesperado: ${e.message}")
    ...
    fun sharePDF(
        ...
        try {
            ...
            Log.e("AndroidPDFService", "Error compartiendo PDF: ${e.message}")
        }
    }
}
